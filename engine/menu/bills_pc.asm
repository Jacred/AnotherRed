...
.asm_21551
	...
	ld [H_AUTOBGTRANSFERENABLED], a ; $ffba
	call Delay3
	ld a,A_BUTTON | B_BUTTON | SELECT ; watch select button too
	ld [wMenuWatchedKeys], a
	call HandleMenuInput
	bit 1, a
	jp nz, Func_21588 ; b button
	bit 2, a ; select button
	jp nz, Func_216b3 ; change box
...
.asm_21682
	...
	call PrintText
;	call YesNoChoiceNoDefault
	call YesNoChoice
	ld a, [wCurrentMenuItem] ; wCurrentMenuItem
;	and a
;	jr nz, .asm_21682
;	ld hl, AreYouREALLYSureText ; $581b
;	call PrintText
;	call YesNoChoiceNoDefault
;	ld a, [wCurrentMenuItem] ; wCurrentMenuItem
	and a
