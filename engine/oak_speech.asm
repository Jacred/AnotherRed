...
OakSpeech: ; 6115 (1:6115)
	...
	call DelayFrames
	call GBPalNormal
;	It's okay to enable this now :)
	ld hl, OakSpeechText2C
	call PrintText
.genderloop
	ld hl, IntroducePlayerGender
	call PrintText
	call SaveScreenTilesToBuffer1
	ld a, $1 ; BOY / GIRL
	ld [wd12c], a
	ld a, B_BUTTON ; don't watch b button
	ld [wJoyIgnore], a
	hlCoord 13, 7
	ld bc, $80e
	ld a, $14
	...
	ld hl, ConfirmBoyText
	jr nc, .confirmboy
	ld hl, ConfirmGirlText
.confirmboy
	call PrintText
	call YesNoChoice
	ld a, [wCurrentMenuItem]
...
OakSpeechText2: ; 6258 (1:6258)
	...
	db "@"
OakSpeechText2C
	TX_FAR _OakSpeechText2C
	db "@"
IntroducePlayerGender:
	TX_FAR _IntroducePlayerGender
	db "@"
ConfirmBoyText:
	TX_FAR _ConfirmBoyText
	db "@"
ConfirmGirlText:
	TX_FAR _ConfirmGirlText
	db "@"
IntroducePlayerText: ; 6262 (1:6262)
	; TX_FAR _IntroducePlayerName FRLG version
