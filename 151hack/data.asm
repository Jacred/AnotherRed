...
; Copied directly from the save file
	db THUNDERBOLT, SURF, FLY, THUNDER ; PIKACHU
	db BODY_SLAM, SURF, THUNDERBOLT, FLAMETHROWER ; EEVEE
	db BODY_SLAM, EARTHQUAKE, REST, HYPER_BEAM ; SNORLAX
	db SURF, BODY_SLAM, BLIZZARD, HYDRO_PUMP ; BLASTOISE
	db RAZOR_LEAF, SLEEP_POWDER, BODY_SLAM, SOLARBEAM ; VENUSAUR
	db FLAMETHROWER, SLASH, DRAGON_RAGE, FIRE_SPIN ; CHARIZARD
