...
VermilionMartText1:: ; 2461 (0:2461)
	db $FE,7,POKE_BALL,SUPER_POTION,ANTIDOTE,PARLYZ_HEAL
	db AWAKENING,ICE_HEAL,REPEL,$FF

; Lavender
LavenderMartText1:: ; 246a (0:246a)
	db $FE,9,GREAT_BALL,SUPER_POTION,ANTIDOTE,PARLYZ_HEAL
	db BURN_HEAL,ICE_HEAL,REVIVE,ESCAPE_ROPE,SUPER_REPEL,$FF
...
CeladonMart2Text2:: ; 2482 (0:2482)
	db $FE,10,POKE_BALL,GREAT_BALL,ULTRA_BALL,ANTIDOTE,PARLYZ_HEAL
	db AWAKENING,BURN_HEAL,ICE_HEAL,FULL_HEAL,ESCAPE_ROPE,$FF
...
; Battle Tent
BattleTentMart::
	db $FE,1,BIKE_VOUCHER,$FF

; Fuchsia
FuchsiaMartText1:: ; 24a8 (0:24a8)
	db $FE,8,GREAT_BALL,ULTRA_BALL,SUPER_POTION,HYPER_POTION,REVIVE
	db FULL_HEAL,SUPER_REPEL,MAX_REPEL,$FF

; Cinnabar
CinnabarMartText1:: ; 24b9 (0:24b9)
	db $FE,8,GREAT_BALL,ULTRA_BALL,HYPER_POTION,REVIVE,FULL_HEAL
	db ESCAPE_ROPE,MAX_REPEL,RARE_CANDY,$FF

; Saffron
SaffronMartText1:: ; 24c3 (0:24c3)
	db $FE,10,GREAT_BALL,ULTRA_BALL,HYPER_POTION,MAX_POTION,REVIVE,FULL_HEAL
	db ESCAPE_ROPE,MAX_REPEL,X_ATTACK,X_DEFEND,$FF

; Indigo
IndigoPlateauLobbyText4:: ; 24cc (0:24cc)
	db FE,12,GREAT_BALL,ULTRA_BALL,HYPER_POTION,MAX_POTION,FULL_RESTORE,REVIVE
	db FULL_HEAL,MAX_REPEL,X_ATTACK,X_DEFEND,X_SPEED,X_SPECIAL,$FF
